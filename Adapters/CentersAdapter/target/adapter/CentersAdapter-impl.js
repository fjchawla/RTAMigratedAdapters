...
//	var vehicleTestingCenters= getVehicleTestingCenters(token).features;
	...
	var result = centers.customerHappinessCenters;
	for (var i = 0 ; i< centers.customerHappinessCenters.length;i++){
		result.push(centers.customerHappinessCenters[i]);
	}
//	result.push(vehicleTestingCenters[0]);
//	var x = [1,3].concat([4,5]);
//	var result = customerHappinessCenters.concat(getVehicleTestingCenters);
	return {
		features:centers.customerHappinessCenters.concat(centers.customerHappinessCenters)
	}
