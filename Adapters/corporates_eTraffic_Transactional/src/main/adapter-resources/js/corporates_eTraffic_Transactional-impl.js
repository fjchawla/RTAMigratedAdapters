...
function createRenewTradeLicenseTransaction(trafficFileNumber, serviceId) {
    try {
        trafficFileNumber = (MFP.Server.getAuthenticatedUser('masterAuthRealm') != undefined && MFP.Server.getAuthenticatedUser('masterAuthRealm') != null) ?MFP.Server.getAuthenticatedUser('masterAuthRealm').corporatesAttributes.trafficNo : trafficFileNumber;
    } catch (e) {
...
function applyForTrainingOnVehicleRental(requestDetail, traineesDetail,
    serviceId) {
    try {
        requestDetail.trafficFileNumber = (MFP.Server.getAuthenticatedUser('masterAuthRealm') != undefined && MFP.Server.getAuthenticatedUser('masterAuthRealm') != null) ?MFP.Server.getAuthenticatedUser('masterAuthRealm').corporatesAttributes.trafficNo : trafficFileNo;
    } catch (e) {
        MFP.Logger.warn("Cannot read data from Realm");
    }
...
function setPendingTransaction(transactionId, trafficFileNumber, serviceId,
    ...
    try {
        trafficFileNumber = (MFP.Server.getAuthenticatedUser('masterAuthRealm') != undefined && MFP.Server.getAuthenticatedUser('masterAuthRealm') != null) ?MFP.Server.getAuthenticatedUser('masterAuthRealm').corporatesAttributes.trafficNo : trafficFileNumber;
        var userId = (MFP.Server.getAuthenticatedUser('masterAuthRealm') != undefined && MFP.Server.getAuthenticatedUser('masterAuthRealm') != null) ?MFP.Server.getAuthenticatedUser('masterAuthRealm').userId : "";
    } catch (e) {
        MFP.Logger.warn("Cannot read data from Realm");
        userId = "";
    }
