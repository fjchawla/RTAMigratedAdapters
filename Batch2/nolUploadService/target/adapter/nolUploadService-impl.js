...
function uploadFileInBase64(language,params) {
	...
	var  newFileBase64 = com.rta.java.adapter.ImageMerge.resizeImageSize(params.fileContentInBase64,MFP.Server.getPropertyValue("rta.image.nolUploadFileSizeLimit"));
...
function uploadMergeFilesInBase64(language,base64File1,base64File2,fileName) {
    ...
    var  newFileBase64 = com.rta.java.adapter.ImageMerge.mergeImage(base64File1, base64File2);
    
    newFileBase64 = com.rta.java.adapter.ImageMerge.resizeImageSize(newFileBase64,MFP.Server.getPropertyValue("rta.image.nolUploadFileSizeLimit"));
